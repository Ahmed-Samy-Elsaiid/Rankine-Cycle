...
%%%%%%%%%
% Copyright (c) 2017, F駘ix P駻ez Cicala

% This program was developed as a Master痴 degree final project. The
% project's name was:

% Modelizacion de ciclos Rankine mediante el m騁odo de Spencer, Cotton y
% Cannon
